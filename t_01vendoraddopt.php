...
$t_01vendor_addopt = NULL; // Initialize page object first

class ct_01vendor_addopt extends ct_01vendor {
	...
	// Page object name
	var $PageObjName = 't_01vendor_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					$row = array();
					$row["x_vendor_id"] = $this->vendor_id->DbValue;
					$row["x_vendor_nama"] = $this->vendor_nama->DbValue;
					if (!EW_DEBUG_ENABLED && ob_get_length())
						ob_end_clean();
	...
	function LoadFormValues() {
		...
		if (!$this->vendor_nama->FldIsDetailKey) {
			$this->vendor_nama->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_vendor_nama")));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->vendor_nama->CurrentValue = ew_ConvertToUtf8($this->vendor_nama->FormValue);
	}
...
// Create page object
if (!isset($t_01vendor_addopt)) $t_01vendor_addopt = new ct_01vendor_addopt();

// Page init
$t_01vendor_addopt->Page_Init();

// Page main
$t_01vendor_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_01vendor_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = ft_01vendoraddopt = new ew_Form("ft_01vendoraddopt", "addopt");

// Validate form
ft_01vendoraddopt.Validate = function() {
...
ft_01vendoraddopt.Form_CustomValidate = 
...
ft_01vendoraddopt.ValidateRequired = true;
<?php } else { ?>
ft_01vendoraddopt.ValidateRequired = false; 
<?php } ?>
...
<?php
$t_01vendor_addopt->ShowMessage();
?>
<form name="ft_01vendoraddopt" id="ft_01vendoraddopt" class="ewForm form-horizontal" action="t_01vendoraddopt.php" method="post">
<?php if ($t_01vendor_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_01vendor_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_01vendor">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($t_01vendor->vendor_nama->Visible) { // vendor_nama ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_vendor_nama"><?php echo $t_01vendor->vendor_nama->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-9">
...
<?php
$t_01vendor_addopt->Page_Terminate();
?>
