...
$t_02item_add = NULL; // Initialize page object first

class ct_02item_add extends ct_02item {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_02itemlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_02itemview.php")
...
// Create page object
if (!isset($t_02item_add)) $t_02item_add = new ct_02item_add();

// Page init
$t_02item_add->Page_Init();

// Page main
$t_02item_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_02item_add->Page_Render();
?>
...
var CurrentForm = ft_02itemadd = new ew_Form("ft_02itemadd", "add");

// Validate form
ft_02itemadd.Validate = function() {
...
ft_02itemadd.Form_CustomValidate = 
...
ft_02itemadd.ValidateRequired = true;
<?php } else { ?>
ft_02itemadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_02itemadd.Lists["x_kat_id"] = {"LinkField":"x_kat_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_kat_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_13kategori"};
ft_02itemadd.Lists["x_sat_id"] = {"LinkField":"x_satuan_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_satuan_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_03satuan"};
...
<?php } ?>
<?php $t_02item_add->ShowPageHeader(); ?>
<?php
$t_02item_add->ShowMessage();
?>
<form name="ft_02itemadd" id="ft_02itemadd" class="<?php echo $t_02item_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_02item_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_02item_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ft_02itemadd.CreateAutoSuggest({"id":"x_kat_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_02itemadd.CreateAutoSuggest({"id":"x_sat_id","forceSelect":true});
</script>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_02item_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
