...
<?php
	...
	if ($userlevels_list->AuditTrailOnSearch && $userlevels_list->Command == "search" && !$userlevels_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $userlevels_list->getSessionWhere();
		$userlevels_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
...
<option value="200"<?php if ($userlevels_list->DisplayRecs == 200) { ?> selected<?php } ?>>200</option>
