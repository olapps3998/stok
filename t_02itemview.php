...
$t_02item_view = NULL; // Initialize page object first

class ct_02item_view extends ct_02item {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["item_id"] <> "") {
			$this->RecKey["item_id"] = $_GET["item_id"];
	...
	function Page_Init() {
		...
		if (@$_GET["item_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["item_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["item_id"] <> "") {
				...
				$this->item_id->setFormValue($_POST["item_id"]);
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_02itemlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_02itemlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_02item_view)) $t_02item_view = new ct_02item_view();

// Page init
$t_02item_view->Page_Init();

// Page main
$t_02item_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_02item_view->Page_Render();
?>
...
var CurrentForm = ft_02itemview = new ew_Form("ft_02itemview", "view");

// Form_CustomValidate event
ft_02itemview.Form_CustomValidate = 
...
ft_02itemview.ValidateRequired = true;
<?php } else { ?>
ft_02itemview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t_02item->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_02item_view->IsModal) { ?>
<?php if ($t_02item->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_02item_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_02item_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_02item_view->IsModal) { ?>
<?php if ($t_02item->Export == "") { ?>
...
<?php } ?>
<?php $t_02item_view->ShowPageHeader(); ?>
<?php
$t_02item_view->ShowMessage();
?>
<?php if (!$t_02item_view->IsModal) { ?>
<?php if ($t_02item->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_02item_view->Pager)) $t_02item_view->Pager = new cPrevNextPager($t_02item_view->StartRec, $t_02item_view->DisplayRecs, $t_02item_view->TotalRecs) ?>
<?php if ($t_02item_view->Pager->RecordCount > 0 && $t_02item_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_02item_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_02item_view->PageUrl() ?>start=<?php echo $t_02item_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_02item_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_02item_view->PageUrl() ?>start=<?php echo $t_02item_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_02item_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_02item_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_02item_view->PageUrl() ?>start=<?php echo $t_02item_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_02item_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_02item_view->PageUrl() ?>start=<?php echo $t_02item_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_02item_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_02itemview" id="ft_02itemview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_02item_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_02item_view->Token ?>">
<?php } ?>
...
<?php echo $t_02item->item_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_02item->item_nama->Visible) { // item_nama ?>
	<tr id="r_item_nama">
		<td><span id="elh_t_02item_item_nama"><?php echo $t_02item->item_nama->FldCaption() ?></span></td>
