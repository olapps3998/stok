...
//
// Table class for r_laba
//
class crr_laba extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'r_laba';
		$this->TableName = 'r_laba';
		...
		// id
		$this->id = new crField('r_laba', 'r_laba', 'x_id', 'id', '`id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// item_id
		$this->item_id = new crField('r_laba', 'r_laba', 'x_item_id', 'item_id', '`item_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// item_nama
		$this->item_nama = new crField('r_laba', 'r_laba', 'x_item_nama', 'item_nama', '`item_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tgl
		$this->tgl = new crField('r_laba', 'r_laba', 'x_tgl', 'tgl', '`tgl`', 200, EWR_DATATYPE_STRING, 0);
		...
		// in_qty
		$this->in_qty = new crField('r_laba', 'r_laba', 'x_in_qty', 'in_qty', '`in_qty`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// in_harga
		$this->in_harga = new crField('r_laba', 'r_laba', 'x_in_harga', 'in_harga', '`in_harga`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// in_sub_total
		$this->in_sub_total = new crField('r_laba', 'r_laba', 'x_in_sub_total', 'in_sub_total', '`in_sub_total`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// out_qty
		$this->out_qty = new crField('r_laba', 'r_laba', 'x_out_qty', 'out_qty', '`out_qty`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// out_harga
		$this->out_harga = new crField('r_laba', 'r_laba', 'x_out_harga', 'out_harga', '`out_harga`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// out_sub_total
		$this->out_sub_total = new crField('r_laba', 'r_laba', 'x_out_sub_total', 'out_sub_total', '`out_sub_total`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// saldo_qty
		$this->saldo_qty = new crField('r_laba', 'r_laba', 'x_saldo_qty', 'saldo_qty', '`saldo_qty`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// saldo_harga
		$this->saldo_harga = new crField('r_laba', 'r_laba', 'x_saldo_harga', 'saldo_harga', '`saldo_harga`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// saldo_sub_total
		$this->saldo_sub_total = new crField('r_laba', 'r_laba', 'x_saldo_sub_total', 'saldo_sub_total', '`saldo_sub_total`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// jenis
		$this->jenis = new crField('r_laba', 'r_laba', 'x_jenis', 'jenis', '`jenis`', 200, EWR_DATATYPE_STRING, -1);
		...
		// detail_id
		$this->detail_id = new crField('r_laba', 'r_laba', 'x_detail_id', 'detail_id', '`detail_id`', 3, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlSelectAgg() {
		return ($this->_SqlSelectAgg <> "") ? $this->_SqlSelectAgg : "SELECT SUM(`out_sub_total`) AS `sum_out_sub_total` FROM " . $this->getSqlFrom();
	}
