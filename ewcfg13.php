...
define("EW_PROJECT_NAME", "prj_stok", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{939D1C58-B1B5-41D0-A0B9-205FEFFF0852}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '85yOwv1Dc7JMlsl7', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/prj_stok.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_stok", "qs" => "`", "qe" => "`");
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "t_00audit_trail", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "t_00audit_trail", TRUE); // Audit trail table var
...
define("EW_USER_TABLE", "`t_97user`", TRUE);
