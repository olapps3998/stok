...
$t_04beli_edit = NULL; // Initialize page object first

class ct_04beli_edit extends ct_04beli {
...
// Create page object
if (!isset($t_04beli_edit)) $t_04beli_edit = new ct_04beli_edit();

// Page init
$t_04beli_edit->Page_Init();

// Page main
$t_04beli_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_04beli_edit->Page_Render();
?>
...
var CurrentForm = ft_04beliedit = new ew_Form("ft_04beliedit", "edit");

// Validate form
ft_04beliedit.Validate = function() {
...
ft_04beliedit.Form_CustomValidate = 
...
ft_04beliedit.ValidateRequired = true;
<?php } else { ?>
ft_04beliedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_04beliedit.Lists["x_vendor_id"] = {"LinkField":"x_vendor_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_vendor_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_01vendor"};
ft_04beliedit.Lists["x_item_id"] = {"LinkField":"x_item_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_item_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_02item"};
ft_04beliedit.Lists["x_satuan_id"] = {"LinkField":"x_satuan_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_satuan_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_03satuan"};
...
<?php } ?>
<?php $t_04beli_edit->ShowPageHeader(); ?>
<?php
$t_04beli_edit->ShowMessage();
?>
<?php if (!$t_04beli_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_04beli_edit->Pager)) $t_04beli_edit->Pager = new cPrevNextPager($t_04beli_edit->StartRec, $t_04beli_edit->DisplayRecs, $t_04beli_edit->TotalRecs) ?>
<?php if ($t_04beli_edit->Pager->RecordCount > 0 && $t_04beli_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_04beli_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_04beli_edit->PageUrl() ?>start=<?php echo $t_04beli_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_04beli_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_04beli_edit->PageUrl() ?>start=<?php echo $t_04beli_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_04beli_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_04beli_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_04beli_edit->PageUrl() ?>start=<?php echo $t_04beli_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_04beli_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_04beli_edit->PageUrl() ?>start=<?php echo $t_04beli_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_04beli_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="ft_04beliedit" id="ft_04beliedit" class="<?php echo $t_04beli_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_04beli_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_04beli_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft_04beliedit", "x_tgl_beli", 7);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ft_04beliedit", "x_tgl_kirim", 7);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ft_04beliedit.CreateAutoSuggest({"id":"x_vendor_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_04beliedit.CreateAutoSuggest({"id":"x_item_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ft_04beliedit.CreateAutoSuggest({"id":"x_satuan_id","forceSelect":true});
</script>
...
<script type="text/javascript">
ew_CreateCalendar("ft_04beliedit", "x_tgl_dp", 7);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ft_04beliedit", "x_tgl_lunas", 7);
</script>
<?php } ?>
</span>
...
<input type="hidden" data-table="t_04beli" data-field="x_beli_id" name="x_beli_id" id="x_beli_id" value="<?php echo ew_HtmlEncode($t_04beli->beli_id->CurrentValue) ?>">
<?php if (!$t_04beli_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_04beli_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($t_04beli_edit->Pager)) $t_04beli_edit->Pager = new cPrevNextPager($t_04beli_edit->StartRec, $t_04beli_edit->DisplayRecs, $t_04beli_edit->TotalRecs) ?>
<?php if ($t_04beli_edit->Pager->RecordCount > 0 && $t_04beli_edit->Pager->Visible) { ?>
