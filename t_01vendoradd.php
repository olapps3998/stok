...
$t_01vendor_add = NULL; // Initialize page object first

class ct_01vendor_add extends ct_01vendor {
	...
	// Page object name
	var $PageObjName = 't_01vendor_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_01vendorlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_01vendorview.php")
...
// Create page object
if (!isset($t_01vendor_add)) $t_01vendor_add = new ct_01vendor_add();

// Page init
$t_01vendor_add->Page_Init();

// Page main
$t_01vendor_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_01vendor_add->Page_Render();
?>
...
var CurrentForm = ft_01vendoradd = new ew_Form("ft_01vendoradd", "add");

// Validate form
ft_01vendoradd.Validate = function() {
...
ft_01vendoradd.Form_CustomValidate = 
...
ft_01vendoradd.ValidateRequired = true;
<?php } else { ?>
ft_01vendoradd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t_01vendor_add->ShowPageHeader(); ?>
<?php
$t_01vendor_add->ShowMessage();
?>
<form name="ft_01vendoradd" id="ft_01vendoradd" class="<?php echo $t_01vendor_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_01vendor_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_01vendor_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_01vendor_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
