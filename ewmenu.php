...
$RootMenu->AddMenuItem(10101, "mci_Proses", $Language->MenuPhrase("10101", "MenuText"), "", -1, "", TRUE, FALSE, TRUE);
$RootMenu->AddMenuItem(10048, "mi_cf_01hitung_nilai_stok_php", $Language->MenuPhrase("10048", "MenuText"), "cf_01hitung_nilai_stok.php", 10101, "", TRUE, FALSE, TRUE);
...
$RootMenu->AddMenuItem(10036, "mri_r5fnilai5fstok", $Language->MenuPhrase("10036", "MenuText"), "r_nilai_stoksmry.php", 9, "{060B3204-5918-44AF-94F8-5E569EA4DD7D}", TRUE, FALSE, FALSE);
