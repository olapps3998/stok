...
//
// Table class for r_transaksi
//
class crr_transaksi extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'r_transaksi';
		$this->TableName = 'r_transaksi';
		...
		// item_id
		$this->item_id = new crField('r_transaksi', 'r_transaksi', 'x_item_id', 'item_id', '`item_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// item_nama
		$this->item_nama = new crField('r_transaksi', 'r_transaksi', 'x_item_nama', 'item_nama', '`item_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tgl
		$this->tgl = new crField('r_transaksi', 'r_transaksi', 'x_tgl', 'tgl', '`tgl`', 133, EWR_DATATYPE_DATE, 7);
		...
		// jenis
		$this->jenis = new crField('r_transaksi', 'r_transaksi', 'x_jenis', 'jenis', '`jenis`', 200, EWR_DATATYPE_STRING, -1);
		...
		// vendor_customer
		$this->vendor_customer = new crField('r_transaksi', 'r_transaksi', 'x_vendor_customer', 'vendor_customer', '`vendor_customer`', 200, EWR_DATATYPE_STRING, -1);
		...
		// qty
		$this->qty = new crField('r_transaksi', 'r_transaksi', 'x_qty', 'qty', '`qty`', 5, EWR_DATATYPE_NUMBER, -1);
		...
		// satuan_nama
		$this->satuan_nama = new crField('r_transaksi', 'r_transaksi', 'x_satuan_nama', 'satuan_nama', '`satuan_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// harga
		$this->harga = new crField('r_transaksi', 'r_transaksi', 'x_harga', 'harga', '`harga`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// sub_total
		$this->sub_total = new crField('r_transaksi', 'r_transaksi', 'x_sub_total', 'sub_total', '`sub_total`', 5, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlSelectAgg() {
		return ($this->_SqlSelectAgg <> "") ? $this->_SqlSelectAgg : "SELECT SUM(`qty`) AS `sum_qty`, SUM(`sub_total`) AS `sum_sub_total` FROM " . $this->getSqlFrom();
	}
