...
class ct_07jual_detail_edit extends ct_07jual_detail {
	...
	function Page_Init() {
		...
		if (!$Security->CanEdit()) {
			...
			if ($Security->CanList())
				$this->Page_Terminate(ew_GetUrl("t_07jual_detaillist.php"));
			else
...
ft_07jual_detailedit.Lists["x_item_id"] = {"LinkField":"x_item_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_item_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_02item"};
