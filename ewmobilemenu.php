...
$RootMenu->AddMenuItem(10054, "mmri_r5fhtg5fint", $Language->MenuPhrase("10054", "MenuText"), "r_htg_intsmry.php", 9, "{060B3204-5918-44AF-94F8-5E569EA4DD7D}", AllowListMenu('{060B3204-5918-44AF-94F8-5E569EA4DD7D}r_htg_int'), FALSE, FALSE);
$RootMenu->AddMenuItem(10316, "mmci_Cetak", $Language->MenuPhrase("10316", "MenuText"), "", -1, "", TRUE, FALSE, TRUE);
$RootMenu->AddMenuItem(10232, "mmi_cf_04cetak_inv01_php", $Language->MenuPhrase("10232", "MenuText"), "cf_04cetak_inv01.php", 10316, "", AllowListMenu('{939D1C58-B1B5-41D0-A0B9-205FEFFF0852}cf_04cetak_inv01.php'), FALSE, TRUE);
