...
$RootMenu->AddMenuItem(10015, "mmri_r5ftransaksi", $Language->MenuPhrase("10015", "MenuText"), "r_transaksismry.php", 9, "{060B3204-5918-44AF-94F8-5E569EA4DD7D}", TRUE, FALSE, FALSE);
$RootMenu->Render();
?>
<!-- End Main Menu -->
