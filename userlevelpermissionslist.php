...
<?php
	...
	if ($userlevelpermissions_list->AuditTrailOnSearch && $userlevelpermissions_list->Command == "search" && !$userlevelpermissions_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $userlevelpermissions_list->getSessionWhere();
		$userlevelpermissions_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
...
<option value="200"<?php if ($userlevelpermissions_list->DisplayRecs == 200) { ?> selected<?php } ?>>200</option>
