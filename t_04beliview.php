...
$t_04beli_view = NULL; // Initialize page object first

class ct_04beli_view extends ct_04beli {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["beli_id"] <> "") {
			$this->RecKey["beli_id"] = $_GET["beli_id"];
			$KeyUrl .= "&amp;beli_id=" . urlencode($this->RecKey["beli_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["beli_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["beli_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["beli_id"] <> "") {
				...
				$this->RecKey["beli_id"] = $this->beli_id->QueryStringValue;
			} elseif (@$_POST["beli_id"] <> "") {
				$this->beli_id->setFormValue($_POST["beli_id"]);
				$this->RecKey["beli_id"] = $this->beli_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("t_04belilist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->beli_id->CurrentValue) == strval($this->Recordset->fields('beli_id'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_04belilist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_04belilist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_04beli_view)) $t_04beli_view = new ct_04beli_view();

// Page init
$t_04beli_view->Page_Init();

// Page main
$t_04beli_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_04beli_view->Page_Render();
?>
...
var CurrentForm = ft_04beliview = new ew_Form("ft_04beliview", "view");

// Form_CustomValidate event
ft_04beliview.Form_CustomValidate = 
...
ft_04beliview.ValidateRequired = true;
<?php } else { ?>
ft_04beliview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_04beliview.Lists["x_vendor_id"] = {"LinkField":"x_vendor_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_vendor_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_01vendor"};
ft_04beliview.Lists["x_item_id"] = {"LinkField":"x_item_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_item_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_02item"};
ft_04beliview.Lists["x_satuan_id"] = {"LinkField":"x_satuan_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_satuan_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_03satuan"};
...
<?php if ($t_04beli->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_04beli_view->IsModal) { ?>
<?php if ($t_04beli->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_04beli_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_04beli_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_04beli_view->IsModal) { ?>
<?php if ($t_04beli->Export == "") { ?>
...
<?php } ?>
<?php $t_04beli_view->ShowPageHeader(); ?>
<?php
$t_04beli_view->ShowMessage();
?>
<?php if (!$t_04beli_view->IsModal) { ?>
<?php if ($t_04beli->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_04beli_view->Pager)) $t_04beli_view->Pager = new cPrevNextPager($t_04beli_view->StartRec, $t_04beli_view->DisplayRecs, $t_04beli_view->TotalRecs) ?>
<?php if ($t_04beli_view->Pager->RecordCount > 0 && $t_04beli_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_04beli_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_04beli_view->PageUrl() ?>start=<?php echo $t_04beli_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_04beli_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_04beli_view->PageUrl() ?>start=<?php echo $t_04beli_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_04beli_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_04beli_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_04beli_view->PageUrl() ?>start=<?php echo $t_04beli_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_04beli_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_04beli_view->PageUrl() ?>start=<?php echo $t_04beli_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_04beli_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_04beliview" id="ft_04beliview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_04beli_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_04beli_view->Token ?>">
<?php } ?>
...
<?php if ($t_04beli->tgl_beli->Visible) { // tgl_beli ?>
	<tr id="r_tgl_beli">
		<td><span id="elh_t_04beli_tgl_beli"><?php echo $t_04beli->tgl_beli->FldCaption() ?></span></td>
...
<?php echo $t_04beli->tgl_beli->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->tgl_kirim->Visible) { // tgl_kirim ?>
	<tr id="r_tgl_kirim">
		<td><span id="elh_t_04beli_tgl_kirim"><?php echo $t_04beli->tgl_kirim->FldCaption() ?></span></td>
...
<?php echo $t_04beli->tgl_kirim->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->vendor_id->Visible) { // vendor_id ?>
	<tr id="r_vendor_id">
		<td><span id="elh_t_04beli_vendor_id"><?php echo $t_04beli->vendor_id->FldCaption() ?></span></td>
...
<?php echo $t_04beli->vendor_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->item_id->Visible) { // item_id ?>
	<tr id="r_item_id">
		<td><span id="elh_t_04beli_item_id"><?php echo $t_04beli->item_id->FldCaption() ?></span></td>
...
<?php echo $t_04beli->item_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t_04beli->satuan_id->Visible) { // satuan_id ?>
	<tr id="r_satuan_id">
		<td><span id="elh_t_04beli_satuan_id"><?php echo $t_04beli->satuan_id->FldCaption() ?></span></td>
...
<?php echo $t_04beli->satuan_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->harga->Visible) { // harga ?>
	<tr id="r_harga">
		<td><span id="elh_t_04beli_harga"><?php echo $t_04beli->harga->FldCaption() ?></span></td>
...
<?php echo $t_04beli->harga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->sub_total->Visible) { // sub_total ?>
	<tr id="r_sub_total">
		<td><span id="elh_t_04beli_sub_total"><?php echo $t_04beli->sub_total->FldCaption() ?></span></td>
...
<?php echo $t_04beli->sub_total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->tgl_dp->Visible) { // tgl_dp ?>
	<tr id="r_tgl_dp">
		<td><span id="elh_t_04beli_tgl_dp"><?php echo $t_04beli->tgl_dp->FldCaption() ?></span></td>
...
<?php echo $t_04beli->tgl_dp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->jml_dp->Visible) { // jml_dp ?>
	<tr id="r_jml_dp">
		<td><span id="elh_t_04beli_jml_dp"><?php echo $t_04beli->jml_dp->FldCaption() ?></span></td>
...
<?php echo $t_04beli->jml_dp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->tgl_lunas->Visible) { // tgl_lunas ?>
	<tr id="r_tgl_lunas">
		<td><span id="elh_t_04beli_tgl_lunas"><?php echo $t_04beli->tgl_lunas->FldCaption() ?></span></td>
...
<?php echo $t_04beli->tgl_lunas->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_04beli->jml_lunas->Visible) { // jml_lunas ?>
	<tr id="r_jml_lunas">
		<td><span id="elh_t_04beli_jml_lunas"><?php echo $t_04beli->jml_lunas->FldCaption() ?></span></td>
...
<?php echo $t_04beli->jml_lunas->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
