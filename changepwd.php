...
class cchangepwd extends ct_97user {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t_97user"])) $GLOBALS["t_97user"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't_97user');
		}
	...
	function Page_Main() {
		...
		if ($bPostBack && $bValidate) {
			...
			// SQL constructor in t_97user class, t_97userinfo.php
