...
//
class crt_97user extends crTableBase {
	...
	function __construct() {
		...
		// user_id
		$this->user_id = new crField('t_97user', 't_97user', 'x_user_id', 'user_id', '`user_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// username
		$this->username = new crField('t_97user', 't_97user', 'x_username', 'username', '`username`', 200, EWR_DATATYPE_STRING, -1);
		...
		// password
		$this->password = new crField('t_97user', 't_97user', 'x_password', 'password', '`password`', 200, EWR_DATATYPE_STRING, -1);
		...
		// userlevel
		$this->userlevel = new crField('t_97user', 't_97user', 'x_userlevel', 'userlevel', '`userlevel`', 3, EWR_DATATYPE_NUMBER, -1);
	...
	function ChildUserIDList($sUserID) {
		...
		// Get all values
		if ($sUserID == "-1") {
			$sSql = "SELECT `user_id` FROM `t_97user`";
		} else {
			$sSql = "SELECT `user_id` FROM `t_97user` WHERE `user_id` = " . ewr_QuotedValue($sUserID, EWR_DATATYPE_NUMBER, $this->DBID);
		}
