...
<?php } ?>
<link href="phpcss/prj_stok2.css" rel="stylesheet" type="text/css">
...
<div class="ewLayout">
	...
	<div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/lab_apps_stok_logo2.png" alt=""></div>
<?php if (ew_IsResponsiveLayout()) { ?>
