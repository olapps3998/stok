...
//
// Table class for r_drop_cash
//
class crr_drop_cash extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'r_drop_cash';
		$this->TableName = 'r_drop_cash';
		...
		// tgl
		$this->tgl = new crField('r_drop_cash', 'r_drop_cash', 'x_tgl', 'tgl', '`tgl`', 133, EWR_DATATYPE_DATE, 7);
		$this->tgl->Sortable = TRUE; // Allow sort
		$this->tgl->GroupingFieldId = 1;
		...
		// jumlah
		$this->jumlah = new crField('r_drop_cash', 'r_drop_cash', 'x_jumlah', 'jumlah', '`jumlah`', 4, EWR_DATATYPE_NUMBER, -1);
		$this->jumlah->Sortable = TRUE; // Allow sort
		$this->jumlah->GroupingFieldId = 2;
		...
		$this->jumlah->FldGroupByType = "";
		$this->jumlah->FldGroupInt = "0";
		$this->jumlah->FldGroupSql = "";

		// branch_nama
		$this->branch_nama = new crField('r_drop_cash', 'r_drop_cash', 'x_branch_nama', 'branch_nama', '`branch_nama`', 200, EWR_DATATYPE_STRING, -1);
		$this->branch_nama->Sortable = TRUE; // Allow sort
		$this->branch_nama->GroupingFieldId = 3;
		$this->branch_nama->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->branch_nama->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		$this->fields['branch_nama'] = &$this->branch_nama;
		$this->branch_nama->DateFilter = "";
		$this->branch_nama->SqlSelect = "";
		$this->branch_nama->SqlOrderBy = "";
		$this->branch_nama->FldGroupByType = "";
		$this->branch_nama->FldGroupInt = "0";
		$this->branch_nama->FldGroupSql = "";

		// tujuan
		$this->tujuan = new crField('r_drop_cash', 'r_drop_cash', 'x_tujuan', 'tujuan', '`tujuan`', 3, EWR_DATATYPE_NUMBER, -1);
		$this->tujuan->Sortable = TRUE; // Allow sort
		$this->tujuan->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		...
		// pemakaian_total
		$this->pemakaian_total = new crField('r_drop_cash', 'r_drop_cash', 'x_pemakaian_total', 'pemakaian_total', '`pemakaian_total`', 4, EWR_DATATYPE_NUMBER, -1);
		$this->pemakaian_total->Sortable = TRUE; // Allow sort
		$this->pemakaian_total->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectFloat");
		$this->fields['pemakaian_total'] = &$this->pemakaian_total;
		$this->pemakaian_total->DateFilter = "";
		$this->pemakaian_total->SqlSelect = "";
		$this->pemakaian_total->SqlOrderBy = "";

		// sisa
		$this->sisa = new crField('r_drop_cash', 'r_drop_cash', 'x_sisa', 'sisa', '`sisa`', 4, EWR_DATATYPE_NUMBER, -1);
		$this->sisa->Sortable = TRUE; // Allow sort
		$this->sisa->GroupingFieldId = 4;
		$this->sisa->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
		$this->sisa->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
		...
		$this->sisa->FldGroupByType = "";
		$this->sisa->FldGroupInt = "0";
		$this->sisa->FldGroupSql = "";

		// beli_id
		$this->beli_id = new crField('r_drop_cash', 'r_drop_cash', 'x_beli_id', 'beli_id', '`beli_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// tgl_beli
		$this->tgl_beli = new crField('r_drop_cash', 'r_drop_cash', 'x_tgl_beli', 'tgl_beli', '`tgl_beli`', 133, EWR_DATATYPE_DATE, 7);
		...
		// tgl_kirim
		$this->tgl_kirim = new crField('r_drop_cash', 'r_drop_cash', 'x_tgl_kirim', 'tgl_kirim', '`tgl_kirim`', 133, EWR_DATATYPE_DATE, 7);
		...
		// vendor_nama
		$this->vendor_nama = new crField('r_drop_cash', 'r_drop_cash', 'x_vendor_nama', 'vendor_nama', '`vendor_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// item_nama
		$this->item_nama = new crField('r_drop_cash', 'r_drop_cash', 'x_item_nama', 'item_nama', '`item_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// qty
		$this->qty = new crField('r_drop_cash', 'r_drop_cash', 'x_qty', 'qty', '`qty`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// satuan_nama
		$this->satuan_nama = new crField('r_drop_cash', 'r_drop_cash', 'x_satuan_nama', 'satuan_nama', '`satuan_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// harga
		$this->harga = new crField('r_drop_cash', 'r_drop_cash', 'x_harga', 'harga', '`harga`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// sub_total
		$this->sub_total = new crField('r_drop_cash', 'r_drop_cash', 'x_sub_total', 'sub_total', '`sub_total`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// tgl_dp
		$this->tgl_dp = new crField('r_drop_cash', 'r_drop_cash', 'x_tgl_dp', 'tgl_dp', '`tgl_dp`', 133, EWR_DATATYPE_DATE, 7);
		...
		// jml_dp
		$this->jml_dp = new crField('r_drop_cash', 'r_drop_cash', 'x_jml_dp', 'jml_dp', '`jml_dp`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// tgl_lunas
		$this->tgl_lunas = new crField('r_drop_cash', 'r_drop_cash', 'x_tgl_lunas', 'tgl_lunas', '`tgl_lunas`', 133, EWR_DATATYPE_DATE, 7);
		...
		// jml_lunas
		$this->jml_lunas = new crField('r_drop_cash', 'r_drop_cash', 'x_jml_lunas', 'jml_lunas', '`jml_lunas`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// dc_id
		$this->dc_id = new crField('r_drop_cash', 'r_drop_cash', 'x_dc_id', 'dc_id', '`dc_id`', 3, EWR_DATATYPE_NUMBER, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_19drop_cash`";
	}
	...
	function getSqlOrderBy() {
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`tgl` ASC, `jumlah` ASC, `branch_nama` ASC, `sisa` ASC";
	}
	...
	function getSqlFirstGroupField() {
		return ($this->_SqlFirstGroupField <> "") ? $this->_SqlFirstGroupField : "`tgl`";
	}
	...
	function getSqlOrderByGroup() {
		return ($this->_SqlOrderByGroup <> "") ? $this->_SqlOrderByGroup : "`tgl` ASC";
	}
