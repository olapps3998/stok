...
$t_99home_add = NULL; // Initialize page object first

class ct_99home_add extends ct_99home {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_99homelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_99homeview.php")
...
// Create page object
if (!isset($t_99home_add)) $t_99home_add = new ct_99home_add();

// Page init
$t_99home_add->Page_Init();

// Page main
$t_99home_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_99home_add->Page_Render();
?>
...
var CurrentForm = ft_99homeadd = new ew_Form("ft_99homeadd", "add");

// Validate form
ft_99homeadd.Validate = function() {
...
ft_99homeadd.Form_CustomValidate = 
...
ft_99homeadd.ValidateRequired = true;
<?php } else { ?>
ft_99homeadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_99homeadd.Lists["x_kat"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_99homeadd.Lists["x_kat"].Options = <?php echo json_encode($t_99home->kat->Options()) ?>;
...
<?php } ?>
<?php $t_99home_add->ShowPageHeader(); ?>
<?php
$t_99home_add->ShowMessage();
?>
<form name="ft_99homeadd" id="ft_99homeadd" class="<?php echo $t_99home_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_99home_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_99home_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft_99homeadd", "x_tgl", 7);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_99home_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
