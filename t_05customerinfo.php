...
//
// Table class for t_05customer
//
class ct_05customer extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't_05customer';
		$this->TableName = 't_05customer';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_05customer`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// customer_id
		$this->customer_id = new cField('t_05customer', 't_05customer', 'x_customer_id', 'customer_id', '`customer_id`', '`customer_id`', 3, -1, FALSE, '`customer_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_05customer`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_05customerview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_05customerview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_05customeradd.php?" . $this->UrlParm($parm);
		else
			$url = "t_05customeradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_05customeredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_05customeradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_05customerdelete.php", $this->UrlParm());
	}
