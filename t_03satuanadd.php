...
$t_03satuan_add = NULL; // Initialize page object first

class ct_03satuan_add extends ct_03satuan {
	...
	// Page object name
	var $PageObjName = 't_03satuan_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_03satuanlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_03satuanview.php")
...
// Create page object
if (!isset($t_03satuan_add)) $t_03satuan_add = new ct_03satuan_add();

// Page init
$t_03satuan_add->Page_Init();

// Page main
$t_03satuan_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_03satuan_add->Page_Render();
?>
...
var CurrentForm = ft_03satuanadd = new ew_Form("ft_03satuanadd", "add");

// Validate form
ft_03satuanadd.Validate = function() {
...
ft_03satuanadd.Form_CustomValidate = 
...
ft_03satuanadd.ValidateRequired = true;
<?php } else { ?>
ft_03satuanadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $t_03satuan_add->ShowPageHeader(); ?>
<?php
$t_03satuan_add->ShowMessage();
?>
<form name="ft_03satuanadd" id="ft_03satuanadd" class="<?php echo $t_03satuan_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_03satuan_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_03satuan_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_03satuan_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
