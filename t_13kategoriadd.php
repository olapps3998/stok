...
$t_13kategori_add = NULL; // Initialize page object first

class ct_13kategori_add extends ct_13kategori {
	...
	// Page object name
	var $PageObjName = 't_13kategori_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_13kategorilist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_13kategoriview.php")
...
// Create page object
if (!isset($t_13kategori_add)) $t_13kategori_add = new ct_13kategori_add();

// Page init
$t_13kategori_add->Page_Init();

// Page main
$t_13kategori_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_13kategori_add->Page_Render();
?>
...
var CurrentForm = ft_13kategoriadd = new ew_Form("ft_13kategoriadd", "add");

// Validate form
ft_13kategoriadd.Validate = function() {
...
ft_13kategoriadd.Form_CustomValidate = 
...
ft_13kategoriadd.ValidateRequired = true;
<?php } else { ?>
ft_13kategoriadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t_13kategori_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t_13kategori_add->ShowPageHeader(); ?>
<?php
$t_13kategori_add->ShowMessage();
?>
<form name="ft_13kategoriadd" id="ft_13kategoriadd" class="<?php echo $t_13kategori_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_13kategori_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_13kategori_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_13kategori_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_13kategoriadd.Init();
</script>
<?php
$t_13kategori_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_13kategori_add->Page_Terminate();
?>
