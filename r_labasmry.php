...
<?php include_once "r_labasmryinfo.php" ?>
<?php
...
$r_laba_summary = NULL; // Initialize page object first

class crr_laba_summary extends crr_laba {
	...
	// Page object name
	var $PageObjName = 'r_laba_summary';
	...
	function __construct() {
		...
		// Table object (r_laba)
		if (!isset($GLOBALS["r_laba"])) {
			$GLOBALS["r_laba"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["r_laba"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'r_laba', TRUE);
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fr_labasummary";
...
//		$item->Visible = TRUE;
		...
		$item->Body = "<a title=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmail", TRUE)) . "\" id=\"emf_r_laba\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_r_laba',hdr:ewLanguage.Phrase('ExportToEmail'),url:'$url',exportid:'$exportid',el:this});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = TRUE;
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fr_labasummary\" href=\"#\">" . $ReportLanguage->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fr_labasummary\" href=\"#\">" . $ReportLanguage->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->Phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fr_labasummary\">" . $ReportLanguage->Phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[1] = $this->out_sub_total->CurrentValue;
			$this->Val[2] = $this->saldo_sub_total->CurrentValue;
		} else {
			$this->id->setDbValue("");
			$this->item_id->setDbValue("");
	...
	function RenderRow() {
		...
		if (!$this->GrandSummarySetup) { // Get Grand total
			...
			if ($rsagg) {
				...
				$this->GrandSmry[1] = $rsagg->fields("sum_out_sub_total");
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			// out_sub_total
			$this->out_sub_total->SumViewValue = $this->out_sub_total->SumValue;
			$this->out_sub_total->SumViewValue = ewr_FormatNumber($this->out_sub_total->SumViewValue, 0, -2, -2, -2);
			$this->out_sub_total->CellAttrs["style"] = "text-align:right;";
			$this->out_sub_total->CellAttrs["class"] = ($this->RowTotalType == EWR_ROWTOTAL_PAGE || $this->RowTotalType == EWR_ROWTOTAL_GRAND) ? "ewRptGrpAggregate" : "ewRptGrpSummary" . $this->RowGroupLevel;
			...
			$this->saldo_sub_total->ViewValue = ewr_FormatNumber($this->saldo_sub_total->ViewValue, $this->saldo_sub_total->DefaultDecimalPrecision, -1, 0, 0);
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// out_sub_total
			$CurrentValue = $this->out_sub_total->SumValue;
			$ViewValue = &$this->out_sub_total->SumViewValue;
...
// Create page object
if (!isset($r_laba_summary)) $r_laba_summary = new crr_laba_summary();
...
// Create page object
var r_laba_summary = new ewr_Page("r_laba_summary");

// Page properties
r_laba_summary.PageID = "summary"; // Page ID
var EWR_PAGE_ID = r_laba_summary.PageID;

// Extend page with Chart_Rendering function
r_laba_summary.Chart_Rendering = 
...
<?php include "r_labasmrypager.php" ?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php } ?>
...
<?php } ?>
<span data-class="tpb<?php echo $Page->GrpCount-1 ?>_r_laba"><?php echo $Page->PageBreakContent ?></span>
<?php } ?>
<?php if ($Page->Export <> "pdf") { ?>
...
<?php if ($Page->item_id->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="item_id"><div class="r_laba_item_id"><span class="ewTableHeaderCaption"><?php echo $Page->item_id->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="item_id">
<?php if ($Page->SortUrl($Page->item_id) == "") { ?>
		<div class="ewTableHeaderBtn r_laba_item_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_id->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_laba_item_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->item_id) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_id->FldCaption() ?></span>
...
<?php if ($Page->item_nama->Visible) { ?>
	...
	<?php } else { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="item_nama"><div class="r_laba_item_nama"><span class="ewTableHeaderCaption"><?php echo $Page->item_nama->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="item_nama">
<?php if ($Page->SortUrl($Page->item_nama) == "") { ?>
		<div class="ewTableHeaderBtn r_laba_item_nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_nama->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_laba_item_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->item_nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_nama->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="out_sub_total"><div class="r_laba_out_sub_total" style="text-align: right;"><span class="ewTableHeaderCaption"><?php echo $Page->out_sub_total->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="out_sub_total">
<?php if ($Page->SortUrl($Page->out_sub_total) == "") { ?>
		<div class="ewTableHeaderBtn r_laba_out_sub_total" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->out_sub_total->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_laba_out_sub_total" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->out_sub_total) ?>',2);" style="text-align: right;">
			<span class="ewTableHeaderCaption"><?php echo $Page->out_sub_total->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="saldo_sub_total"><div class="r_laba_saldo_sub_total"><span class="ewTableHeaderCaption"><?php echo $Page->saldo_sub_total->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="saldo_sub_total">
<?php if ($Page->SortUrl($Page->saldo_sub_total) == "") { ?>
		<div class="ewTableHeaderBtn r_laba_saldo_sub_total">
			<span class="ewTableHeaderCaption"><?php echo $Page->saldo_sub_total->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer r_laba_saldo_sub_total" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->saldo_sub_total) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->saldo_sub_total->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ewSummaryCaption r_laba_item_id"><span class="ewTableHeaderCaption"><?php echo $Page->item_id->FldCaption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->SortUrl($Page->item_id) == "") { ?>
		<span class="ewSummaryCaption r_laba_item_id">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_id->FldCaption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r_laba_item_id" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->item_id) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_id->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->item_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->item_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
...
<span data-class="tpx<?php echo $Page->GrpCount ?>_r_laba_item_id"<?php echo $Page->item_id->ViewAttributes() ?>><?php echo $Page->item_id->GroupViewValue ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
		<span class="ewSummaryCaption r_laba_item_nama"><span class="ewTableHeaderCaption"><?php echo $Page->item_nama->FldCaption() ?></span></span>
<?php } else { ?>
	<?php if ($Page->SortUrl($Page->item_nama) == "") { ?>
		<span class="ewSummaryCaption r_laba_item_nama">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_nama->FldCaption() ?></span>
		</span>
	<?php } else { ?>
		<span class="ewTableHeaderBtn ewPointer ewSummaryCaption r_laba_item_nama" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->item_nama) ?>',2);">
			<span class="ewTableHeaderCaption"><?php echo $Page->item_nama->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->item_nama->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->item_nama->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</span>
	<?php } ?>
<?php } ?>
		<?php echo $ReportLanguage->Phrase("SummaryColon") ?>
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_laba_item_nama"<?php echo $Page->item_nama->ViewAttributes() ?>><?php echo $Page->item_nama->GroupViewValue ?></span>
...
<?php
			...
			$Page->out_sub_total->Count = $Page->Cnt[1][1];
			$Page->out_sub_total->SumValue = $Page->Smry[1][1]; // Load SUM
			$Page->ResetAttrs();
			$Page->RowType = EWR_ROWTYPE_TOTAL;
			$Page->RowTotalType = EWR_ROWTOTAL_GROUP;
...
<span<?php echo $Page->item_id->ViewAttributes() ?>><?php echo $Page->item_id->GroupSummaryViewValue ?></span>
	<?php } else { ?>
		<span class="ewSummaryCount"><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptCnt") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><?php echo ewr_FormatNumber($Page->item_id->Count,0,-2,-2,-2) ?></span></span>
	<?php } ?>
		</td>
...
<span<?php echo $Page->item_nama->ViewAttributes() ?>><?php echo $Page->item_nama->GroupSummaryViewValue ?></span>
	<?php } else { ?>
		<span class="ewSummaryCount">
<span data-class="tpx<?php echo $Page->GrpCount ?>_<?php echo $Page->GrpCounter[0] ?>_r_laba_item_nama"<?php echo $Page->item_nama->ViewAttributes() ?>><?php echo $Page->item_nama->GroupViewValue ?></span>&nbsp;(<span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptCnt") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><?php echo ewr_FormatNumber($Page->item_nama->Count,0,-2,-2,-2) ?></span>)</span>
	<?php } ?>
		</td>
<?php } ?>
<?php if ($Page->out_sub_total->Visible) { ?>
		<td data-field="out_sub_total"<?php echo $Page->item_id->CellAttributes() ?>><span class="ewAggregateCaption"><?php echo $ReportLanguage->Phrase("RptSum") ?></span><?php echo $ReportLanguage->Phrase("AggregateEqual") ?><span class="ewAggregateValue"><span data-class="tpgs<?php echo $Page->GrpCount ?>_r_laba_out_sub_total"<?php echo $Page->out_sub_total->ViewAttributes() ?>><?php echo $Page->out_sub_total->SumViewValue ?></span></span></td>
<?php } ?>
<?php if ($Page->saldo_sub_total->Visible) { ?>
...
<?php } ?>
<?php if ($Page->out_sub_total->Visible) { ?>
		<td data-field="out_sub_total"<?php echo $Page->saldo_sub_total->CellAttributes() ?>>
<span data-class="tpgs<?php echo $Page->GrpCount ?>_r_laba_out_sub_total"<?php echo $Page->out_sub_total->ViewAttributes() ?>><?php echo $Page->out_sub_total->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->saldo_sub_total->Visible) { ?>
		<td data-field="saldo_sub_total"<?php echo $Page->item_id->CellAttributes() ?>>&nbsp;</td>
<?php } ?>
...
<tfoot>
<?php
	$Page->out_sub_total->Count = $Page->GrandCnt[1];
	$Page->out_sub_total->SumValue = $Page->GrandSmry[1]; // Load SUM
	$Page->ResetAttrs();
	$Page->RowType = EWR_ROWTYPE_TOTAL;
...
<?php } ?>
<?php if ($Page->out_sub_total->Visible) { ?>
		<td data-field="out_sub_total"<?php echo $Page->out_sub_total->CellAttributes() ?>><?php echo $ReportLanguage->Phrase("RptSum") ?>=<span data-class="tpts_r_laba_out_sub_total"<?php echo $Page->out_sub_total->ViewAttributes() ?>><?php echo $Page->out_sub_total->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->saldo_sub_total->Visible) { ?>
		<td data-field="saldo_sub_total"<?php echo $Page->saldo_sub_total->CellAttributes() ?>></td>
<?php } ?>
	</tr>
<?php } else { ?>
...
<span data-class="tpts_r_laba_out_sub_total"<?php echo $Page->out_sub_total->ViewAttributes() ?>><?php echo $Page->out_sub_total->SumViewValue ?></span></td>
<?php } ?>
<?php if ($Page->saldo_sub_total->Visible) { ?>
		<td data-field="saldo_sub_total"<?php echo $Page->saldo_sub_total->CellAttributes() ?>>&nbsp;</td>
<?php } ?>
