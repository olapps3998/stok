...
//
// Table class for r_mutasi
//
class crr_mutasi extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'r_mutasi';
		$this->TableName = 'r_mutasi';
		...
		// item_id
		$this->item_id = new crField('r_mutasi', 'r_mutasi', 'x_item_id', 'item_id', '`item_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// item_nama
		$this->item_nama = new crField('r_mutasi', 'r_mutasi', 'x_item_nama', 'item_nama', '`item_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tgl
		$this->tgl = new crField('r_mutasi', 'r_mutasi', 'x_tgl', 'tgl', '`tgl`', 133, EWR_DATATYPE_DATE, 7);
		...
		// masuk
		$this->masuk = new crField('r_mutasi', 'r_mutasi', 'x_masuk', 'masuk', '`masuk`', 4, EWR_DATATYPE_NUMBER, -1);
		...
		// keluar
		$this->keluar = new crField('r_mutasi', 'r_mutasi', 'x_keluar', 'keluar', '`keluar`', 4, EWR_DATATYPE_NUMBER, -1);
