...
define("EWR_PROJECT_ID", "{060B3204-5918-44AF-94F8-5E569EA4DD7D}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "prj_stok", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_stok", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'zFn5MVQ18fIoan8p', TRUE); // Random key for encryption
...
define("EWR_TABLE_PREFIX", "{060B3204-5918-44AF-94F8-5E569EA4DD7D}", TRUE);
