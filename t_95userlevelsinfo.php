...
//
// Table class for t_95userlevels
//
class ct_95userlevels extends cTable {
	var $userlevelid;
	var $userlevelname;
	...
	function __construct() {
		...
		$this->TableVar = 't_95userlevels';
		$this->TableName = 't_95userlevels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_95userlevels`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t_95userlevels', 't_95userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new cField('t_95userlevels', 't_95userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_95userlevels`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_95userlevelsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_95userlevelsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_95userlevelsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_95userlevelsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_95userlevelsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_95userlevelsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_95userlevelsdelete.php", $this->UrlParm());
	}
